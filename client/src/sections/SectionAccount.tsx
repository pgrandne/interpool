                ...
                <div className="container-3 w-container">
                    ...
                    <div className="w-layout-grid grid-5">
                        ...
                        <div id="w-node-_23834aa8-b05c-48c4-6c93-858034514a29-3d3dc5f0">
                            <a href="/" data-w-id="10726a2a-0f38-c4f5-17d4-b50ee7aa8dd5" className="hollow-button white">Redeem your tickets</a>
                        </div>
                        ...
                        <div id="w-node-_3613a481-370e-2c98-3fc4-cbfe298cc1cd-3d3dc5f0" className="div-block-49">
                            <a href="/" data-w-id="072ecfd4-6168-39ba-d6f7-70c0be435150" className="hollow-button white hollow-button-inverted">Get more tickets!</a>
                            <a href="/" data-w-id="072ecfd4-6168-39ba-d6f7-70c0be435150" className="hollow-button white hollow-button-inverted">Claim now!</a>
                        </div>

...
function WcGroupPhase({ ticket, contestId, nbPlayers }: { ticket: number, contestId: number, nbPlayers: number }) {
                ...
                <div>
                    <div className="w-layout-grid grid-3">
                        ...
                        <div id="w-node-_006b4fe0-e8a9-281b-f781-f492cd502992-3d3dc5f0" className="form-block w-form">
                            <div id="" className="form-3">
                                <input type="number" className={typeof game3854558 === 'undefined' ? "text-field-2 w-input" : colorInput(game3854558[1], game3854558[2], 1, 2)}
                                    readOnly placeholder={typeof game3854558 === 'undefined' ? '' : game3854558[1].toString()} />
                                <input type="number" className={typeof game3854558 === 'undefined' ? "text-field-2 w-input" : colorInput(game3854558[1], game3854558[2], 1, 2)}
                                    readOnly placeholder={typeof game3854558 === 'undefined' ? '' : game3854558[2].toString()} />
                            </div>
                        </div>
                        <div id="w-node-_3c513a16-b1ef-9be5-a5ed-438efde39358-3d3dc5f0" className="content-grid-prediction">Senegal</div>
                        <div id="w-node-f4954d84-1ad6-5ba6-3f03-ddb58eac9cc1-3d3dc5f0" className="content-grid-prediction-smaller">(1-2)</div>
                        {/* 3854557 */}
                        ...
                        <div id="w-node-_5290c7e8-d089-7e9c-1eb3-a1437a212c84-3d3dc5f0" className="form-block w-form">
                            <div id="" className="form-3">
                                <input type="number" className={typeof game3854557 === 'undefined' ? "text-field-2 w-input" : colorInput(game3854557[1], game3854557[2], 2, 0)}
                                    readOnly placeholder={typeof game3854557 === 'undefined' ? '' : game3854557[1].toString()} />
                                <input type="number" className={typeof game3854557 === 'undefined' ? "text-field-2 w-input" : colorInput(game3854557[1], game3854557[2], 2, 0)}
                                    readOnly placeholder={typeof game3854557 === 'undefined' ? '' : game3854557[2].toString()} />
                            </div>
                        </div>
                        <div id="w-node-fa5aae3c-4413-c772-3895-ba8bb9702369-3d3dc5f0" className="content-grid-prediction">Qatar</div>
                        <div id="w-node-_432301b4-79cf-d381-abbc-64f0ef16a3cd-3d3dc5f0" className="content-grid-prediction-smaller">(2-0)</div>
                    </div>
                </div>
                <div>
                    <div className="w-layout-grid grid-3">
                        ...
                        <div id="w-node-_6d320c88-0c1c-8e7b-1a62-ca9cd216c676-3d3dc5f0" className="form-block w-form">
                            <div id="" className="form-3">
                                <input type="number" className={typeof game3854563 === 'undefined' ? "text-field-2 w-input" : colorInput(game3854563[1], game3854563[2], 0, 3)}
                                    readOnly placeholder={typeof game3854563 === 'undefined' ? '' : game3854563[1].toString()} />
                                <input type="number" className={typeof game3854563 === 'undefined' ? "text-field-2 w-input" : colorInput(game3854563[1], game3854563[2], 0, 3)}
                                    readOnly placeholder={typeof game3854563 === 'undefined' ? '' : game3854563[2].toString()} />
                            </div>
                        </div>
                        <div id="w-node-_6d320c88-0c1c-8e7b-1a62-ca9cd216c680-3d3dc5f0" className="content-grid-prediction">England</div>
                        <div id="w-node-_6d320c88-0c1c-8e7b-1a62-ca9cd216c672-3d3dc5f0" className="content-grid-prediction-smaller">(0-3)</div>
                        {/* 3854564 */}
                        ...
                        <div id="w-node-_6d320c88-0c1c-8e7b-1a62-ca9cd216c688-3d3dc5f0" className="form-block w-form">
                            <div id="" className="form-3">
                                <input type="number" className={typeof game3854564 === 'undefined' ? "text-field-2 w-input" : colorInput(game3854564[1], game3854564[2], 0, 1)}
                                    readOnly placeholder={typeof game3854564 === 'undefined' ? '' : game3854564[1].toString()} />
                                <input type="number" className={typeof game3854564 === 'undefined' ? "text-field-2 w-input" : colorInput(game3854564[1], game3854564[2], 0, 1)}
                                    readOnly placeholder={typeof game3854564 === 'undefined' ? '' : game3854564[2].toString()} />
                            </div>
                        </div>
                        <div id="w-node-_6d320c88-0c1c-8e7b-1a62-ca9cd216c692-3d3dc5f0" className="content-grid-prediction">USA</div>
                        <div id="w-node-_6d320c88-0c1c-8e7b-1a62-ca9cd216c684-3d3dc5f0" className="content-grid-prediction-smaller">(0-1)</div>
                    </div>
                </div>
            </div>
            <div className="div-block-17">
                ...
                <div>
                    <div className="w-layout-grid grid-3">
                        ...
                        <div id="w-node-d6998ca8-d344-e20b-6360-2aacd1200180-3d3dc5f0" className="form-block w-form">
                            <div className="form-3">
                                <input type="number" className={typeof game3854589 === 'undefined' ? "text-field-2 w-input" : colorInput(game3854589[1], game3854589[2], 2, 1)}
                                    readOnly placeholder={typeof game3854589 === 'undefined' ? '' : game3854589[1].toString()} />
                                <input type="number" className={typeof game3854589 === 'undefined' ? "text-field-2 w-input" : colorInput(game3854589[1], game3854589[2], 2, 1)}
                                    readOnly placeholder={typeof game3854589 === 'undefined' ? '' : game3854589[2].toString()} />
                            </div>
                        </div>
                        ...
                        <div id="w-node-d6998ca8-d344-e20b-6360-2aacd1200192-3d3dc5f0" className="form-block w-form">
                            <div className="form-3">
                                <input type="number" className={typeof game3854590 === 'undefined' ? "text-field-2 w-input" : colorInput(game3854590[1], game3854590[2], 2, 4)}
                                    readOnly placeholder={typeof game3854590 === 'undefined' ? '' : game3854590[1].toString()} />
                                <input type="number" className={typeof game3854590 === 'undefined' ? "text-field-2 w-input" : colorInput(game3854590[1], game3854590[2], 2, 4)}
                                    readOnly placeholder={typeof game3854590 === 'undefined' ? '' : game3854590[2].toString()} />
                            </div>
                        </div>
                ...
                <div>
                    <div className="w-layout-grid grid-3">
                        ...
                        <div id="w-node-d6998ca8-d344-e20b-6360-2aacd12001f1-3d3dc5f0" className="form-block w-form">
                            <div className="form-3">
                                <input type="number" className={typeof game3854596 === 'undefined' ? "text-field-2 w-input" : colorInput(game3854596[1], game3854596[2], 1, 2)}
                                    readOnly placeholder={typeof game3854596 === 'undefined' ? '' : game3854596[1].toString()} />
                                <input type="number" className={typeof game3854596 === 'undefined' ? "text-field-2 w-input" : colorInput(game3854596[1], game3854596[2], 1, 2)}
                                    readOnly placeholder={typeof game3854596 === 'undefined' ? '' : game3854596[2].toString()} />
                            </div>
                        </div>
                        ...
                        <div id="w-node-d6998ca8-d344-e20b-6360-2aacd1200203-3d3dc5f0" className="form-block w-form">
                            <div className="form-3">
                                <input type="number" className={typeof game3854595 === 'undefined' ? "text-field-2 w-input" : colorInput(game3854595[1], game3854595[2], 0, 0)}
                                    readOnly placeholder={typeof game3854595 === 'undefined' ? '' : game3854595[1].toString()} />
                                <input type="number" className={typeof game3854595 === 'undefined' ? "text-field-2 w-input" : colorInput(game3854595[1], game3854595[2], 0, 0)}
                                    readOnly placeholder={typeof game3854595 === 'undefined' ? '' : game3854595[2].toString()} />
                            </div>
                        </div>
                ...
                <div>
                    <div className="w-layout-grid grid-3">
                        ...
                        <div id="w-node-_74aead76-a63d-8f28-d55e-d94c20febf27-3d3dc5f0" className="form-block w-form">
                            <div className="form-3">
                                <input type="number" className={typeof game3854602 === 'undefined' ? "text-field-2 w-input" : colorInput(game3854602[1], game3854602[2], 2, 3)}
                                    readOnly placeholder={typeof game3854602 === 'undefined' ? '' : game3854602[1].toString()} />
                                <input type="number" className={typeof game3854602 === 'undefined' ? "text-field-2 w-input" : colorInput(game3854602[1], game3854602[2], 2, 3)}
                                    readOnly placeholder={typeof game3854602 === 'undefined' ? '' : game3854602[2].toString()} />
                            </div>
                        </div>
                        ...
                        <div id="w-node-_74aead76-a63d-8f28-d55e-d94c20febf39-3d3dc5f0" className="form-block w-form">
                            <div className="form-3">
                                <input type="number" className={typeof game3854601 === 'undefined' ? "text-field-2 w-input" : colorInput(game3854601[1], game3854601[2], 1, 0)}
                                    readOnly placeholder={typeof game3854601 === 'undefined' ? '' : game3854601[1].toString()} />
                                <input type="number" className={typeof game3854601 === 'undefined' ? "text-field-2 w-input" : colorInput(game3854601[1], game3854601[2], 1, 0)}
                                    readOnly placeholder={typeof game3854601 === 'undefined' ? '' : game3854601[2].toString()} />
                            </div>
                        </div>
                ...
                <div>
                    <div className="w-layout-grid grid-3">
                        ...
                        <div id="w-node-_74aead76-a63d-8f28-d55e-d94c20febf98-3d3dc5f0" className="form-block w-form">
                            <div className="form-3">
                                <input type="number" className={typeof game3854607 === 'undefined' ? "text-field-2 w-input" : colorInput(game3854607[1], game3854607[2], 2, 1)}
                                    readOnly placeholder={typeof game3854607 === 'undefined' ? '' : game3854607[1].toString()} />
                                <input type="number" className={typeof game3854607 === 'undefined' ? "text-field-2 w-input" : colorInput(game3854607[1], game3854607[2], 2, 1)}
                                    readOnly placeholder={typeof game3854607 === 'undefined' ? '' : game3854607[2].toString()} />
                            </div>
                        </div>
                        ...
                        <div id="w-node-_74aead76-a63d-8f28-d55e-d94c20febfaa-3d3dc5f0" className="form-block w-form">
                            <div className="form-3">
                                <input type="number" className={typeof game3854608 === 'undefined' ? "text-field-2 w-input" : colorInput(game3854608[1], game3854608[2], 0, 2)}
                                    readOnly placeholder={typeof game3854608 === 'undefined' ? '' : game3854608[1].toString()} />
                                <input type="number" className={typeof game3854608 === 'undefined' ? "text-field-2 w-input" : colorInput(game3854608[1], game3854608[2], 0, 2)}
                                    readOnly placeholder={typeof game3854608 === 'undefined' ? '' : game3854608[2].toString()} />
                            </div>
                        </div>
